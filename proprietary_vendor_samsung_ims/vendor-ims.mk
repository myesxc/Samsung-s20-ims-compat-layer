# Files needed for IMS enablement on Samsung Galaxy S20 (SM-G98x, Snapdragon 865)
# Derived from firmware SM-G981N G981NKSU1HVJG (Android 13).
#
# NOTE: ims_sock_launch is a project-specific helper binary (not from Samsung firmware).
# See c/ for the source and build instructions.
...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/ims/proprietary/system/bin/ims_sock_launch:$(TARGET_COPY_OUT_SYSTEM)/bin/ims_sock_launch
...
PRODUCT_COPY_FILES += \
    vendor/samsung/ims/proprietary/system/lib64/libapims_signaling.so:$(TARGET_COPY_OUT_SYSTEM)/lib64/libapims_signaling.so \
    ...
    vendor/samsung/ims/proprietary/system/lib64/vendor.samsung.hardware.radio-V1-ndk.so:$(TARGET_COPY_OUT_SYSTEM)/lib64/vendor.samsung.hardware.radio-V1-ndk.so \
    vendor/samsung/ims/proprietary/system/lib64/vendor.samsung.hardware.radio.bridge-V1-ndk.so:$(TARGET_COPY_OUT_SYSTEM)/lib64/vendor.samsung.hardware.radio.bridge-V1-ndk.so \
